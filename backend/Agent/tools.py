...
class ProblemStatementUrl(BaseModel):
    query: str = Field(description="should be a url of the format https:/leetcode.com/problems/problem_name/description")
...
class ProblemDescriptionSearchTool(BaseTool):
    ...
    def _run(self, query : str, run_manager : Optional[CallbackManagerForToolRun] = None) -> str:
        ...
        description_response = requests.get(LEETCODE_API+"/select?titleSlug="+problem_name)
