  ...
  return (
    <div className="border-b border-white/20 last:border-b-0 hover:bg-white/5 rounded-lg">
      ...
      >
        ...
        <span className={`ml-6 flex-shrink-0 text-white p-2 rounded-full ${isOpen ? 'bg-white/10' : ''}`}>
          {isOpen ? (
      ...
      <div 
        className={`overflow-hidden transition-all ease-in-out duration-300 ${isOpen ? 'max-h-40' : 'max-h-0'}`}
      >
